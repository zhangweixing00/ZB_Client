...
namespace SharpMap.Rendering
{
    ...
    public class VectorRenderer
    {
            ...
            if (pol.ExteriorRing.Vertices.Count > 2)
            {
                ...
                for (int i = 0; i < pol.InteriorRings.Count; i++)
                    if (!clip)
                        ...
                        DrawPolygonClipped(gp, pol.InteriorRings[i].TransformToImage(map), map.Size.Width, map.Size.Height);
        ...
        private static void DrawPolygonClipped(GraphicsPath gp, System.Drawing.PointF[] polygon, int width, int height)
        {
            ...
            {
                System.Drawing.PointF[] clippedPolygon = clipPolygon(polygon, width, height);
        ...
        private static ClipState DetermineClipState(System.Drawing.PointF[] vertices, int width, int height)
        {
        ...
        internal static System.Drawing.PointF[] clipPolygon(System.Drawing.PointF[] vertices, int width, int height)
        {
            ...
            if (line.Count > 0)
                line.Add(new System.Drawing.PointF(line[0].X, line[0].Y));
