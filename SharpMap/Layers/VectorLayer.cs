...
namespace SharpMap.Layers
{
	...
	public class VectorLayer : Layer, IDisposable
	{
        ...
        public VectorLayer(string layername, int vieworder)
		{
		...
		public VectorLayer(string layername,int vieworder, SharpMap.Data.Providers.IProvider dataSource) : this(layername,vieworder)
		{
